            ...
            <tr>
                <td align="left" valign="center">
                    <div
                        ...
                        <div style="padding-bottom: 30px; font-size: 14px; line-height: 24px;">You're one step closer to
                            getting started with Skillsider.
                        </div>
                        <div style="padding-bottom: 30px; font-size: 14px; line-height: 24px;">Your package is
                            {{$details['package']}}.
                        </div>
                        <!--end:Email content-->
