                        ...
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="dropdown profile-dropdown d-flex">
                                ...
                                <span class="header-avatar1">
                                        <img src="{{ Auth::user()->profile_photo_url }}" alt="img" class="avatar avatar-md brround">
                                    </span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
                                    <div class="text-center">
                                        <div class="text-center user pb-0 font-weight-bold ">{{ Auth::user()->name }}</div>
                                        <span class="text-center user-semi-title px-2">{{ Auth::user()->email }}</span>
                                        <div class="dropdown-divider"></div>
                                    </div>
                                    <a class="dropdown-item d-flex" href="{{ route('change.profile.image') }}">
