            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1 d-none">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Courses Details</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-body pt-0  pb-0">
                        <div class="card-header cursor-pointer">
                            ...
                            <a href="{{ route('courses.create') }}"
                                class="btn btn-sm text-light btn-primary align-self-center">Add Course</a>
                            <!--end::Action-->
                            ...
                            <tbody>
                                ...
                                @foreach ($courses as $course)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('course-image/' . $course->image) }}" width="50"
                                                alt="">
                                        </td>
                                        ...
                                        <td class="  text-start d-flex">
                                            <!--begin::Menu-->
                                                ...
                                                <div class="menu-item px-3">
                                                    ...
                                                    {{-- <a href="{{ route('courses.update', ['course' => $course->id]) }}">Update Package</a> --}}

                                                </div>
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <p>
                                                        <a type="button" id="delete-course-{{  $course->id }}" class="menu-link px-3 btn btn-danger">
                                                            Delete
                                                        </a>
