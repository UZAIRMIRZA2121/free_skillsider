            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1 d-none">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Rank</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
                        ...
                        <!--end::Item-->
                        <li class="breadcrumb-item text-muted">Rank Course</li>
                    ...
                    <div class="card-body pt-0  pb-0">
                        ...
                        <div>
                            <form class="Course_form form w-100  " novalidate="novalidate" id="kt_sign_up_form"
                                method="POST" enctype="multipart/form-data" action="{{ route('rank.store') }}">
                                @csrf
                                <div class="row  pt-6">
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="mb-10">
                                            ...
                                            <input type="text" name="name"
                                                class="form-control form-control-solid"  placeholder="Rank Name"
                                                required />
                                    ...
                                    <!--            class="form-control form-control-solid"   placeholder="Task Amount"-->
                                    <!--            required min="1" />-->
                                    ...
                                    <!--</div>-->
                                     <div class="col-lg-6 col-sm-12">
                                        <div class="mb-10">
                                            <label class="required form-label">Task To Add People</label>
                                            <input type="number" name="task_people"
                                                class="form-control form-control-solid"   placeholder="Task To Add People"
                                                required min="1" />
                                     ...
                                     <div class="col-lg-6 col-sm-12">
                                        <div class="mb-10">
                                            ...
                                            <input type="number" name="reward_amount"
                                                class="form-control form-control-solid"   placeholder="Reward Amount"
                                                required min="1" />
