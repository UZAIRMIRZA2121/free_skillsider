            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1 d-none">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Rank Details</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                             ...
                             <tbody>
                                ...
                                @foreach ($ranks as $rank)
                                    <tr>
                                        <td> {{ $i++ }} </td>
                                        <td>{{$rank->name}}</td>
                                        <td>{{$rank->task_people}}</td>
                                        <!--<td>{{$rank->task_amount}}</td>-->
                                        <td>{{$rank->reward_amount}}</td>
                                        <td class="  text-start">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4 "
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('rank.edit', ['id' => $rank->id]) }}"
                                                ...
                                                <div class="menu-item px-3">
                                                    <p>
                                                        <a type="button" id="delete-course-{{  $rank->id }}" class="menu-link px-3">
                                                            Delete
                                                        </a>
                                                    <form id="delete-form-{{ $rank->id }}"
                                                        action="{{ route('rank.destroy', $rank->id) }}"
