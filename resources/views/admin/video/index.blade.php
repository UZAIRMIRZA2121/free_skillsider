                                ...
                                @foreach ($videos as $video)
                                    <tr>
                                        ...
                                        @else
                                            <td></td>
                                        @endif
                                        <td>{{ $video->courses->course_title }}</td>
                                        <td>
                                            @if ($video->resource_link)
                                        ...
                                        <td class="  text-start d-flex">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('videos.show', ['video' => $video->id]) }}"
                                                    class="menu-link px-3 btn btn-warning"
                                            ...
                                            <div class="menu-item px-3">
                                                <p>
                                                    <a type="button" id="delete-videos-{{ $video->id }}"
                                                        class="menu-link px-3 btn btn-danger">
                                                        Delete
                                                    </a>
