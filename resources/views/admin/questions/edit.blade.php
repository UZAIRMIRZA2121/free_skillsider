            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card mb-5 mb-xxl-8">
                    <div class="card-body pt-0  pb-0">
                        ...
                        <div>
                            <form action="{{ route('questions.update', $question->id) }}" method="POST" id="kt_sign_up_form">
                                @csrf
                                @method('PUT') <!-- Include this method to specify it's an update request -->
                                
                                <div class="row pt-6">
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="mb-10">
                                            <label for="course_id" class="form-label">Course</label>
                                            <select name="course_id" class="form-control form-control-solid" required>
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="mb-10">
                                            ...
                                            <textarea name="question_text" class="form-control form-control-solid" required>{{ $question->question_text }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="mb-10">
                                            ...
                                            <input type="text" name="option_1" class="form-control form-control-solid" required value="{{ $question->option_1 }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="mb-10">
                                            ...
                                            <input type="text" name="option_2" class="form-control form-control-solid" required value="{{ $question->option_2 }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="mb-10">
                                            ...
                                            <input type="text" name="option_3" class="form-control form-control-solid" required value="{{ $question->option_3 }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="mb-10">
                                            ...
                                            <input type="text" name="option_4" class="form-control form-control-solid" required value="{{ $question->option_4 }}">
                                        </div>
                                    </div>
                                ...
                                <div class="card-header cursor-pointer">
                                    ...
                                    <button type="submit" id="save_btn" class="btn btn-md text-light btn-primary align-self-center">Save</button>
                                </div>
                            </form>
