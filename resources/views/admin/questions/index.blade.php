            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1 d-none">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Questions Details</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-body pt-0  pb-0">
                        <div class="card-header cursor-pointer">
                            ...
                            <div class="card-title m-0">
                                <h3 class="fw-bold m-0">Questions</h3>
                            </div>
                            <!--end::Card title-->
                            <!--begin::Action-->
                        ...
                        <table id="kt_datatable_dom_positioning"
                            ...
                            <tbody>
                                @foreach ($questions as $question)
                                    <tr>
                                        <td>{{ $question->course->course_title }}</td>
                                        <td>{{ $question->question_text }}</td>
                                        <td>{{ $question->option_1 }}, {{ $question->option_2 }}, {{ $question->option_3 }}, {{ $question->option_4 }}</td>
