            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card mb-5 mb-xxl-8">
                    <div class="card-body pt-0  pb-0">
                        ...
                        @endif
                        <form action="{{ route('faq_affiliate_videos.update',$faqAffiliateVideo->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row pt-6">
                                <div class="col-lg-6 col-sm-12">
                                    <div class="mb-10">
                                        ...
                                        <input type="text" value="{{$faqAffiliateVideo->title}}" name="title" class="form-control form-control-solid"
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <div class="mb-10">
                                        ...
                                        <input type="text" value="{{$faqAffiliateVideo->video_link}}" name="video_link" class="form-control form-control-solid"
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div class="d-flex mt-3">
                                            <div class="form-check">
                                              ...
                                              <input class="form-check-input" type="radio"  name="type" id="faq" value="1" {{ $faqAffiliateVideo->type == 1 ? 'checked' : '' }} >
                                           ...
                                           <div class="form-check ms-5">
                                              <input class="form-check-input" type="radio"  name="type" id="affiliate" value="0" {{ $faqAffiliateVideo->type == 0 ? 'checked' : '' }} >
