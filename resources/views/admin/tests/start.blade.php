                    ...
                    <div class="card-body pt-0 pb-0">
                        ...
                        <form action="{{ route('submit-test') }}" method="POST">
                                            ...
                                            <div class="col-12 col-md-6 col-lg-3 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        onclick="handleOptionChange({{ $question->id }}, 1)">
                                            ...
                                            <div class="col-12 col-md-6 col-lg-3 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        onclick="handleOptionChange({{ $question->id }}, 2)">
                                                    <label class="form-check-label fw-bold"
                                            ...
                                            <div class="col-12 col-md-6 col-lg-3 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        onclick="handleOptionChange({{ $question->id }}, 3)">
                                                    <label class="form-check-label fw-bold"
                                            ...
                                            <div class="col-12 col-md-6 col-lg-3 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        onclick="handleOptionChange({{ $question->id }}, 4)">
                                                    <label class="form-check-label fw-bold"
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" class="btn btn-primary px-4 py-2 m-3">Submit Test</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        window.addEventListener('beforeunload', function (e) {
            ...
            const confirmationMessage = 'Are you sure you want to leave this page? Any unsaved progress may be lost.';
            
            // Standard message for some browsers (this will trigger a confirmation dialog)
            e.returnValue = confirmationMessage;

            // For modern browsers, return the message for custom behavior
            return confirmationMessage;
        });

        // Preventing refresh via F5, CTRL+R, etc.
        document.addEventListener("keydown", function (e) {
            if ((e.key === "F5") || (e.ctrlKey && e.key === "r")) {
                e.preventDefault(); // Prevent refresh on F5 or CTRL+R
            }
        });
        ...
        // Preventing middle-click (button 1)
        document.addEventListener("mousedown", function (e) {
            if (e.button === 1) { // Middle mouse button
                e.preventDefault(); // Disable middle-click
                alert("Middle-click is disabled.");
            }
        });

        // Preventing back button or mouse gestures (navigation)
