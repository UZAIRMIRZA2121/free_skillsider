        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Unrequested Amount</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1 d-none">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Unrequested Amount</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-body pt-0  pb-0">
                        <div class="card-header cursor-pointer">
                            ...
                            <div class="card-title m-0">
                                <h3 class="fw-bold m-0">Unrequested Amount</h3>
                            </div>
                            <!--end::Card title-->
                            <!--begin::Action-->
                            ...
                            <thead>
                             ...
                             <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>{{ optional($earning->user)->first_name }}</td>
                                  <td>{{ optional($earning->user)->email }}</td>
                                  <td>{{ $earning->total_amount }}</td>
                              </tr>
                          @endforeach
