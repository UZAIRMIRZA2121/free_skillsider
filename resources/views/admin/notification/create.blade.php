        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Notification Management</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1 d-none">
                        ...
                        <!--end::Item-->
                        <li class="breadcrumb-item text-muted">Notification Course</li>
                    ...
                    <div class="card-body pt-0  pb-0">
                        <div class="card-header cursor-pointer">
                            ...
                            <div class="card-title m-0">
                                <h3 class="fw-bold ">Add Notification </h3>
                            </div>
                            <!--end::Card title-->
                            <!--begin::Action-->
                        ...
                        <div>
                            <form action="{{ route('notifications.store') }}" method="POST" id="kt_sign_up_form">
                                @csrf
                                <div class="row  pt-6">
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="mb-10">
                                            <label for="title" class="form-label">Title</label>
                                            <input type="text" name="title" class="form-control form-control-solid" id="title"  placeholder="Title" value="{{ old('title') }}" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <select name="package_id" class="form-control form-control-solid" id="package_id" >
                                                ...
                                                @foreach($packages as $package)
                                                    <option value="{{ $package->id }}" {{ old('package_id') == $package->id ? 'selected' : '' }}>{{ $package->package_title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                     <div class="col-lg-12 col-sm-12">
                                        <div class="mb-10">
                                            ...
                                            <textarea name="message" class="form-control form-control-solid" id="message" rows="4" required>{{ old('message') }}</textarea>
                                        </div>
                                    </div> 
                                     <!-- Blog Description -->
                            <div class="col-lg-12 col-sm-12">
                                <div class="mb-10">
                                    <label for="long_desc" class="required form-label">Long Description</label>
                                    <div id="editor"></div>
