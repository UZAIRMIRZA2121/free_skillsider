                    ...
                    <div class="card-body pt-0  pb-0">
                        ...
                        <div>
                            <form class="package_form form w-100" novalidate="novalidate" id="kt_sign_up_form"
                                method="POST" enctype="multipart/form-data" action="{{ Auth::user()->role == 1 ? route('payment.admin.store'):route('payments.store') }}">
                                @csrf
                                <div class="row pt-6">
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="mb-10">
                                            ...
                                            <input type="text" name="bank"
                                                class="form-control form-control-solid" value="{{ old('bank') }}"
                                                placeholder="Bank" />
                                            @error('bank')
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="mb-10">
                                            ...
                                            <input type="text" name="account_name" class="form-control form-control-solid"
                                                placeholder="Account Name" required value="{{ old('account_name') }}" />
                                            @error('account_name')
                                                <span class="error text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
