                        ...
                        <div class="packages_body_inner">
                            <div class="d-flex justify-content-center">
                                @foreach ($marketTools as $tool)
                                    <a href="{{ Route('market_tool_link_std', ['id' => $tool->id]) }}">
                                        <div class="package-card text-center m-2" style="background-color: #f9f9f9">
                                            <div class="overflow-hidden">
                                                <img src="{{ asset('uploads/market_tools/' . $tool->img) }}"
                                                    class="img img-thumbnail" alt="" height="250">
                                            </div>
                                            <div class="package_inner_body">
                                                <p class="package_text fw-bolder">
                                                    <a
                                                        href="{{ Route('market_tool_link_std', ['id' => $tool->id]) }}">{{ $tool->title }}</a>
                                                </p>
                                            </div>
                                        </div>
                                    </a>
